...
def eval_all(expressions, env):
    ...
    current_result = scheme_eval(expressions.first, env)
...
class Frame(object):
    ...
    def lookup(self, symbol):
        ...
        # BEGIN PROBLEM 3
        try:
            if symbol in self.bindings or self.parent is None:
    ...
    def make_child_frame(self, formals, vals):
        ...
        if len(formals) != len(vals):
            ...
            for _ in range(len(formals)):
                newFrame.bindings[formals.first] = vals.first
