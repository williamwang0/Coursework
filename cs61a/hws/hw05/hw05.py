...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, key):
        nonlocal balance, count, badpass

        if count == 3:
        	return "Your account is locked. Attempts: " + str(badpass)
...
def make_joint(withdraw, old_password, new_password):
    ...
    bala = withdraw(0, old_password)

    def func(amt, pas):
    	if pas == new_password or pas == old_password:
    		return withdraw(amt, old_password)
    	return withdraw(amt, pas)
