...
def free_bacon(score):
    ...
    onesPlace = score%10
    tensPlace = score//10
    return min(onesPlace, tensPlace) + 1
...
def is_swap(player_score, opponent_score):
    ...
    if player_score%10 == opponent_score%10:
        return True
    elif player_score//10%10 == opponent_score//10%10:
        if player_score//10%10 == 0:
            return False
        else:
            return True
    else:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    while max(goal, score0 + 1, score1 + 1) == goal:
        if player:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while rollNum < 11:
        diceRoll = make_averaged(roll_dice, num_samples)
        pointsEarned = diceRoll(rollNum, dice)
        if pointsEarned > previous_high:
            high_index = rollNum
            previous_high = pointsEarned
        rollNum += 1

    return high_index

    # BEGIN PROBLEM 9
    #def bestNumRoll(dice, previous_high, rollnumber, high_index):
    #    if(rollnumber > 10):
    #        return high_index
    #    diceRoll = make_averaged(roll_dice,num_samples)
    #    pointsEarned = diceRoll(rollnumber,dice)
    #    if(pointsEarned>previous_high):
    #        return bestNumRoll(dice, pointsEarned, rollnumber + 1, rollnumber)
    #    else:
    #        return bestNumRoll(dice,previous_high,rollnumber + 1,high_index)
    #
    #return bestNumRoll(dice,0,1,0)
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    elif free_bacon(opponent_score) + score == opponent_score:
            return bacon_strategy(score, opponent_score,margin,num_rolls)
    else:
        if is_swap(free_bacon(opponent_score) + score, opponent_score):
            return num_rolls
